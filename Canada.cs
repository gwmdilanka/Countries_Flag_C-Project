...
{
    [Serializable()]
    class Canada : AnyCountry
    {
        // constructor	
        public Canada(string countryName, int x_at, int y_at, int flag_width, int flag_height)
        ...
        public override void Display(Graphics g)
        {
            if (g != null)
            {
                ...
                Bitmap bitImage = new Bitmap(Properties.Resources.Canada);
