...
{
    [Serializable()]
    class Zimbabwe : AnyCountry
    {
        // constructor	
        public Zimbabwe(string countryName, int x_at, int y_at, int flag_width, int flag_height)
        ...
        public override void Display(Graphics g)
        {
            if (g != null)
            {
                Bitmap bitImage = new Bitmap(Properties.Resources.Zimbabwe);
