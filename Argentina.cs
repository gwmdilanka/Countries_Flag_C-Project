...
{
    [Serializable()]
    class Argentina : AnyCountry
    {
        // constructor	
        public Argentina(string countryName, int x_at, int y_at, int flag_width, int flag_height)
            : base(countryName, x_at, y_at, flag_width, flag_height)
        {

        }

        // override method to display country as text
        ...
        public override void Display(Graphics g)
        {
            if (g != null)
            {
                ...
                Bitmap bitImage = new Bitmap(Properties.Resources.Argentina);
            ...
            if (Highlight)
            {
                ...
                int borderSide = flag_width - 3; // make slightly smaller than flag to avoid shadow
                int borderTop = flag_height - 3;
